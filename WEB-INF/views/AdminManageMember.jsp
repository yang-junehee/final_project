			...
			<div class="contents">
				<div class="tab_content">
					...
					<div class="conbox con1">
						<div style="font-weight: bold; margin-left: 40%; padding: 50px 0; font-size: 30px;">회원 관리</div> 
						<div class="boxing">
							<div class="contents_top">
								<div class="box">
									<div class="container-4">
										<form action="searchMemberInAdmin" name="searchMemberInAdmin"
											method="GET">
											<input type="search" id="search" name="keyword"
												placeholder="이름 또는 아이디로 조회" />
											<button class="icon">
												<i class="fa fa-search" onclick="searchMember()"></i>
												<script>
													function searchMember() {
														searchMemberInAdmin.submit();
													}
												</script>
											</button>
										</form>
								...
								<table class="goods_list">
									...
									<c:forEach var="memberList" items="${memberList}">
										<tr>
											...
											<td><button class="genric-btn danger" onclick="location.href='adminDeleteMember?mid=${memberList.mid}'">삭제</button></td>
										</tr>
									</c:forEach>
								</table>
							</div>
...
<script type="text/javascript"
	src="http://code.jquery.com/jquery-1.12.2.js"></script>
