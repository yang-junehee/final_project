			...
			<div class="contents">
				<div class="tab_content">
					...
					<input type="radio" name="tabmenu" id="tab01" checked> <label
						for="tab01">어트랙션 관리</label> 

					<!-- 탭메뉴 내용 -->
					<!-- 전체 -->
					<div class="conbox con1">
						<div
					style="font-weight: bold; margin-left: 40%; padding: 50px 0; font-size: 30px;">어트랙션 관리</div>
						<div class="boxing">
			
							<div class="top_button">
							<!-- 어트랙션 등록 -->
								<form action="attractionAdd" enctype="multipart/form-data" name="addForm" method="post">
								<table>
									<tr>
										<th style="width: 15%;">번호</th>
										<th><input type="text" name="anum" style="border:solid 2px black; width: 380px;"></th>	
										<th>이름</th>
										<th><input type="text" name="aname" style="border:solid 2px black; width: 380px;"></th>
									</tr>
									<tr>	
										<th style="width: 15%;">정보</th>
										<th><input type="text" name="ainformation" style="border:solid 2px black; width: 380px;"></th>	
										<th>구역 </th>
										<th><input type="text" name="azone" style="border:solid 2px black; width: 380px;"></th>
									</tr>
									<tr>
										<th style="width: 15%;">최소 키</th>
										<th><input type="text" name="aminheight" style="border:solid 2px black; width: 380px;"></th>
										<th>이미지</th>
										<th><input type="file" name="afile" style="border:solid 2px black; width: 380px;"></th>
									</tr>
								</table>
									<input type="hidden" name="alike" value="0">

									<button class="button_registerGoods" onclick="attractionAdd()">등록</button>
								</form>
							</div>
							...
							<div class="goods_table">
								<table class="goods_list">
									...
									<c:forEach var="attraction" items="${attractionList}">
										<tr>
											<td>${attraction.anum}<input type="hidden"
												value="${attraction.anum}" /></td>
											<td>${attraction.aname} <input type="hidden"
												 value="${attraction.aname}" />
											</td>
											<td>${attraction.azone}<input type="hidden"
												value="${attraction.azone}" />
											</td>
											<td><a href="attractionDelete?anum=${attraction.anum}" style="color:black;">삭제</a>
											</td>
										</tr>
									</c:forEach>
								</table>
