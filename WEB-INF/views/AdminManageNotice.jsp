			...
			<div class="contents">
				<div class="tab_content">
					...
					<input type="radio" name="tabmenu" id="tab01" checked> <label
						...
						for="tab02">등록<span class="count_box"></span>
					</label>
					...
					<div class="conbox con1">
						<div
							style="font-weight: bold; margin-left: 40%; padding: 50px 0; font-size: 30px;">공지사항
							정보 관리</div>
						<div class="boxing">
								...
								<table class="goods_list">
									...
									<c:forEach var="notice" items="${noticeList}">
										<tr>
											...
											<td>공지</td>
											<td><a
												href="boardView?nnum=${notice.nnum}&page=${paging.page}">${notice.ntitle}</a></td>
											<td>${notice.ndate }</td>
											<td><button class="genric-btn danger"
													onclick="location.href='noticeDelete?nnum=${notice.nnum}&page=${page}'">삭제</button>
									</c:forEach>
								</table>
							</div>
						</div>
						...
						<div class="pagingList_row">
							<div class="pagingList_col">
								...
								<div class="boxing">
									...
									<form action="noticeWriteFile" method="post"
										name="noticeWriteForm" enctype="multipart/form-data">
										<table style="margin-left: 50px;">
											<tr>
												<th>작성자</th>
												<td>${sessionScope.loginID}<input type="hidden"
													name="nwriter" value="${sessionScope.loginID}" />
												</td>
											</tr>
											<tr>
												<th>비밀번호</th>
												<td><input type="password" name="npw"
													style="width: 700px; border: solid 2px black;" /></td>
											</tr>
											<tr>
												<th>제목</th>
											...
											<tr>
												<th>내용</th>
												<td><textarea class="noresize" name="ncontents"
														cols="75" rows="6" wrap="hard"
														style="border: solid 2px black;"></textarea>
											</tr>
											<tr>
												<th>첨부파일</th>
												<td><input type="file" name="nfile"
													style="width: 700px; border: solid 2px black;"></td>
											</tr>
										</table>
										<button class="genric-btn danger"
											style="width: 150px; height: 60px; font-size: 20px; font-weight: bold; margin-left: 32%;"
											onclick="noticeWrite()">글등록</button>
									</form>
										<script>
