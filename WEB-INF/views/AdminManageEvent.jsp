			...
			<div class="contents">
				<div class="tab_content">
					...
					<div class="conbox con1">
						<div
							style="font-weight: bold; margin-left: 40%; padding: 50px 0; font-size: 30px;">이벤트
							정보 관리</div>
						<div class="boxing">				
							<div class="top_button">
							<!-- 이벤트 등록 -->
								<form action="eventAdd" enctype="multipart/form-data" name="eventForm" method="post">
								<table>
									<tr>
										<th>제목  <input type="text" name="evtitle" style="border:solid 2px black; width: 1000px;"></th>
									</tr>
									<tr>
										<th>이벤트 창 이미지  <input type="file" name="evfile" style="border:solid 2px black; width: 1000px;">
									</tr>
									<tr>	
										<th>배너 이미지  <input type="file" name="evbannerfile" style="border:solid 2px black; width: 1000px;">								
									</tr>
								</table><br/>
								<button class="button_registerGoods" onclick="eventAdd()">이벤트 등록</button>
								</form>
							</div>
						...
						<div class="goods_table">
							<table class="goods_list">
								...
								<c:forEach var="event" items="${eventList}">
									<tr>
										<td>${event.evnumber}<input type="hidden"
											value="${event.evnumber}" /></td>
										<td><a href="eventsView?evnumber=${event.evnumber}">${event.evtitle}</a><input type="hidden"
											value="${event.evtitle}" />
										</td>
										<td><a href="eventDelete?evnumber=${event.evnumber}"
