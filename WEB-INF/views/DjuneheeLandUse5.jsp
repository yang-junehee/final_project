                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-8 col-md-8">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="fadeInUp" data-delay=".4s" >우대정보</h1>
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="assets/img/blog/single_blog_1.png" alt="">
                                        ...
                                        <h3 class="blog_item_date" style="font-size:30px; font-weight:bold;">DjuneheeLand 우대정보</h3>
                                    
                                </div>
                                <div class="blog_details">
                                    
                                        <h3 class="blog-head" style="color: #2d2d2d;">ㆍDjuneheeLand 키오스크 우대</h3>
                                    
                                    <p>&nbsp;&nbsp;- 기간 : 2020년 10월 1일(목) ~ 10월 31일(토)<br/>
                                       &nbsp;&nbsp;- 대상 : 교복 착용한 고객 본인<br/>
                                       &nbsp;&nbsp;- 장소 : 티켓 키오스크<br/>
                                       &nbsp;&nbsp;- 유의사항<br/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;기타 우대 및 카드 할인과 중복 적용되지 않습니다.<br/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;티켓키오스크에서만 이용 가능한 우대이며, 현장 매표소에서는 이용이 불가합니다.<br/>
                                       &nbsp;&nbsp;- 기타사항<br/>	  
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;티켓 베이비는 우대에 해당되지 않습니다.<br/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;기타 우대행사 및 카드 할인과 중복 적용되지 않습니다.<br/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;당사 사정에 의해 행사 내용이 변경될 수 있습니다.<br/>
                                    </p>
                                    
                                    
                                        <h3 class="blog-head" style="color: #2d2d2d;">ㆍDjuneheeLand 이용고객 우대</h3>
                                  
                                    <p>&nbsp;&nbsp;- 기간 : 2020년 10월 1일(목) ~ 10월 31일(토)<br/>
                                       &nbsp;&nbsp;- 대상 : 10월에 구매하신 DjuneheeLand 티켓 또는 티켓영수증 소지 고객 본인<br/>
                                       &nbsp;&nbsp;- 유의사항 <br/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;반드시 DjuneheeLand 티켓 또는 티켓영수증을 소지해 주시기 바랍니다.<br/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;티켓 또는 티켓영수증이 없을 시 구매내역을 보여주십시오.<br/>
                                       &nbsp;&nbsp;- 기타사항<br/>	  
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;티켓 구매 당일에 한하여 이용 가능합니다.<br/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;기타우대 및 카드 할인과 중복 적용되지 않습니다.<br/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;단체 행사, 베이비권, 외국인은 적용되지 않습니다. (단, 유효기간 내외국인 등록증 소지시 이용 가능합니다.)<br/>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;기타 이용관련 문의 : 032-123-4567
                                    </p>
                                </div>
                            </article>
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            <aside class="single_sidebar_widget post_category_widget">
                                <h4 class="widget_title" style="color: #2d2d2d;">우대 정보</h4>
