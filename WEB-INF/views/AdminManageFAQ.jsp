			...
			<div class="contents">
				<div class="tab_content">
					...
					<div class="conbox con1">
						<div
							style="font-weight: bold; margin-left: 40%; padding: 50px 0; font-size: 30px;">FAQ 정보 관리</div>
						<div class="boxing">

							<div class="top_button">
								<!-- 어트랙션 등록 -->
								<form action="faqWrite" name="faqAdd" method="GET">
									<table>
										<tr>
											<th>카테고리</th>
											<th><select name="fcategory">
													<option value="001">이용안내</option>
													<option value="002">단체예약</option>
													<option value="003">리조트</option>
													<option value="004">홈페이지</option>
													<option value="005">기타</option>
											</select></th>
										</tr>
										<tr>
											<th>질문</th>
											<th><textarea class="noresize" name="fquestion"
													cols="100" rows="5" wrap="hard"
													style="border: solid 2px black;"></textarea></th>
										</tr>
										<tr>
											<th>대답</th>
											<th><textarea class="noresize" name="fanswer" cols="100"
													rows="5" wrap="hard" style="border: solid 2px black;"></textarea></th>
										</tr>
									</table>
									<button class="button_registerGoods" onclick="faqAdd()">등록</button>
								</form>
							</div>
							<br/><br/>
							...
							<div class="goods_table">
								<table class="faqTable">
									...
									<c:forEach var="faq" items="${faqList}">
										<tr>
											<td>${faq.fcategory}<input type="hidden"
												value="${faq.fcategory}" /></td>
											<td>${faq.fnumber}<input type="hidden"
												value="${faq.fnumber}" />
											</td>
											<td>${faq.fquestion}<input type="hidden"
												value="${faq.fquestion}" />
											</td>
											<td><a href="faqDelete?fnumber=${faq.fnumber}"
												style="color: black;">삭제</a></td>
										</tr>
									</c:forEach>
								</table>
							</div>
