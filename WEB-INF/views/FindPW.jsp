                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-8">
                        ...
                        <div class="login-form">
                            <!-- Login Heading -->
                            <form action="findPw" id="contact_form" class="contact_form"  method="post">
                            <div class="login-heading">
                                <span>비밀번호 찾기</span>
                                <p>가입시 입력한 아이디와 핸드폰번호를 입력하세요</p>
                            </div>
                            <!-- Single Input Fields -->
                            <div class="input-box">
                                ...
                                <div class="single-input-fields">
                                    ...
                                    <input type="text" name = "mid" id="id" placeholder="가입한 아이디를 입력하세요">
                                </div>
                                
                                <div class="single-input-fields">
                                    <label for="mphone">핸드폰번호 <span style="font-size:15px; color:gray;"> (숫자만입력)</span></label>
                                    <input type="text" name = "mphone" id="mphone" placeholder="가입한 핸드폰 번호를 입력하세요">
                                </div>
                            ...
                            <div class="login-footer">
                                ...
                                <button class="submit-btn3" onclick="submit()">비밀번호 찾기</button>
                            </div>
                            </form>
                        </div>
                    </div>
